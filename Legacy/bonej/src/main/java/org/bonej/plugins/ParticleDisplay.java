...
public class ParticleDisplay {
	 ...
	 */
	static ImagePlus displayParticleValues(final ImagePlus imp,
	...
	static void display3DOriginal(final ImagePlus imp,
	 ...
	 */
	static void displayCentroids(final double[][] centroids,
	...
	static void displayEllipsoids(final Object[][] ellipsoids,
		final Image3DUniverse univ)
	{
	 ...
	 */
	static ImagePlus displayParticleLabels(final int[][] particleLabels,
		final ImagePlus imp)
	{
		final int w = imp.getWidth();
		final int h = imp.getHeight();
	 ...
	 */
	static void displayParticleSurfaces(final Image3DUniverse univ,
	...
	static void displayPrincipalAxes(final Image3DUniverse univ,
